...
public class InitRawEvent {
    ...
    public static RawEvent initRawEvent(HashMap m, String parser) {
        ...
        if (parser.contains("agent")) {
            ...
            HashMap<String, Object> clientDataMap = TypeTransUtil.ObjectToHashMap(m.get(ParserConstants.CLIENTDATA));
            ...
            HashMap<String, Object> clientDataMap = TypeTransUtil.ObjectToHashMap(m.get(ParserConstants.CLIENTDATA));
            clientData.setUrlQueryString(TypeTransUtil.ObjectToString(clientDataMap.get(ParserConstants.URLQUERYSTRING)));
            ...
            HashMap<String, Object> clientDataMap = TypeTransUtil.ObjectToHashMap(m.get(ParserConstants.CLIENTDATA));
            clientData.setReferrer(TypeTransUtil.ObjectToString(clientDataMap.get(ParserConstants.REFERRER)));
            ...
            HashMap<String, Object> clientDataMap = TypeTransUtil.ObjectToHashMap(m.get(ParserConstants.CLIENTDATA));
            clientData.setRemoteIP(TypeTransUtil.ObjectToString(clientDataMap.get(ParserConstants.REMOTEIP)));
            clientData.setForwardFor(TypeTransUtil.ObjectToString(clientDataMap.get(ParserConstants.FORWARDFOR)));
            ...
            HashMap<String,Object> rheosHeaderMap = TypeTransUtil.ObjectToHashMap(m.get(ParserConstants.RHEOSHEADER));
            rheosHeader.setEventCreateTimestamp(TypeTransUtil.ObjectToLong(rheosHeaderMap.get(ParserConstants.EVENTCREATETIMESTAMP)));
