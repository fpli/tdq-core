...
public class MapStateDesc {
    ...
    public static final MapStateDescriptor<String, Map<Integer, Long>> attributeSignatureDesc = new MapStateDescriptor<>(
            "broadcast-attributeSignature-state", BasicTypeInfo.STRING_TYPE_INFO, TypeInformation.of(new TypeHint<Map<Integer, Long>>() {
    })
    );
