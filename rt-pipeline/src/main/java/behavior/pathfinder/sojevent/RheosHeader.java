...
public class RheosHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static behavior.pathfinder.sojevent.RheosHeader.Builder newBuilder() {
    return new behavior.pathfinder.sojevent.RheosHeader.Builder();
  }
  
  /** Creates a new RheosHeader RecordBuilder by copying an existing Builder */
  public static behavior.pathfinder.sojevent.RheosHeader.Builder newBuilder(behavior.pathfinder.sojevent.RheosHeader.Builder other) {
    return new behavior.pathfinder.sojevent.RheosHeader.Builder(other);
  }
  
  /** Creates a new RheosHeader RecordBuilder by copying an existing RheosHeader instance */
  public static behavior.pathfinder.sojevent.RheosHeader.Builder newBuilder(behavior.pathfinder.sojevent.RheosHeader other) {
    return new behavior.pathfinder.sojevent.RheosHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RheosHeader>
    ...
    private Builder() {
      super(behavior.pathfinder.sojevent.RheosHeader.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(behavior.pathfinder.sojevent.RheosHeader.Builder other) {
      super(other);
    ...
    private Builder(behavior.pathfinder.sojevent.RheosHeader other) {
            super(behavior.pathfinder.sojevent.RheosHeader.SCHEMA$);
      if (isValidValue(fields()[0], other.eventCreateTimestamp)) {
        this.eventCreateTimestamp = data().deepCopy(fields()[0].schema(), other.eventCreateTimestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'eventCreateTimestamp' field */
    public behavior.pathfinder.sojevent.RheosHeader.Builder setEventCreateTimestamp(long value) {
    ...
    public behavior.pathfinder.sojevent.RheosHeader.Builder clearEventCreateTimestamp() {
    ...
    /** Sets the value of the 'eventSentTimestamp' field */
    public behavior.pathfinder.sojevent.RheosHeader.Builder setEventSentTimestamp(long value) {
    ...
    public behavior.pathfinder.sojevent.RheosHeader.Builder clearEventSentTimestamp() {
    ...
    /** Sets the value of the 'schemaId' field */
    public behavior.pathfinder.sojevent.RheosHeader.Builder setSchemaId(int value) {
    ...
    public behavior.pathfinder.sojevent.RheosHeader.Builder clearSchemaId() {
    ...
    /** Sets the value of the 'eventId' field */
    public behavior.pathfinder.sojevent.RheosHeader.Builder setEventId(java.lang.String value) {
    ...
    public behavior.pathfinder.sojevent.RheosHeader.Builder clearEventId() {
      eventId = null;
    ...
    /** Sets the value of the 'producerId' field */
    public behavior.pathfinder.sojevent.RheosHeader.Builder setProducerId(java.lang.String value) {
    ...
    public behavior.pathfinder.sojevent.RheosHeader.Builder clearProducerId() {
      producerId = null;
