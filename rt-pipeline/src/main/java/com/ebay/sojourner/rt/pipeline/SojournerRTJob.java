...
public class SojournerRTJob {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataStream<RawEvent> rawEventDataStreamForRNO = SourceDataStreamBuilder.build(
        ...
        FlinkEnvUtils.getListString(Property.BEHAVIOR_PATHFINDER_BOOTSTRAP_SERVERS_RNO),
    ...
    DataStream<RawEvent> rawEventDataStreamForSLC = SourceDataStreamBuilder.build(
        executionEnvironment,
        FlinkEnvUtils.getString(Property.BEHAVIOR_PATHFINDER_TOPIC),
        FlinkEnvUtils.getListString(Property.BEHAVIOR_PATHFINDER_BOOTSTRAP_SERVERS_SLC),
    ...
    DataStream<AgentIpAttribute> agentIpAttributeDatastream =
        sessionCoreDataStream
            ...
            .slotSharingGroup(FlinkEnvUtils.getString(Property.PRE_AGENT_IP_SLOT_SHARE_GROUP))
    ...
    DataStream<BotSignature> agentIpSignatureDataStream = agentIpAttributeDatastream
        ...
        .slotSharingGroup(FlinkEnvUtils.getString(Property.AGENT_IP_SLOT_SHARE_GROUP))
    ...
    DataStream<BotSignature> agentSignatureDataStream = agentIpAttributeDatastream
        ...
        .slotSharingGroup(FlinkEnvUtils.getString(Property.AGENT_SLOT_SHARE_GROUP))
    ...
    DataStream<BotSignature> ipSignatureDataStream = agentIpAttributeDatastream
        ...
        .slotSharingGroup(FlinkEnvUtils.getString(Property.IP_SLOT_SHARE_GROUP))
