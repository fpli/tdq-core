...
public class MockBehaviorPathfinderSource extends AbstractSource {
  public static List<DataStream<RawEvent>> build(final StreamExecutionEnvironment env) {
    ...
    SingleOutputStreamOperator<RawEvent> src3 = env.addSource(new MockTdqRawEventSourceFunction())
        .name("Raw Event Src3")
        .uid("raw-event-src3")
    ...
    SingleOutputStreamOperator<RawEvent> src4 = env.addSource(new MockTdqRawEventSourceFunction())
        .name("Raw Event Src4")
        .uid("raw-event-src4")
