...
//        executionEnvironment.setParallelism(100);
        ...
        DataStream<RawEvent> rawEventDataStream = executionEnvironment.addSource(
                KafkaConnectorFactoryForSOJ.createKafkaConsumerWithRawEvent().assignTimestampsAndWatermarks(
...
//                .name("IP Signature").disableChaining();
        sessionStream.addSink(new SojHdfsSink<UbiSession>(UbiSession.class)).name("UbiSession Sink");
