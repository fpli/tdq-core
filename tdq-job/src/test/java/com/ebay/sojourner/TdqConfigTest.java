...
public class TdqConfigTest {
    public static ProfilerConfig createProfilerExample1() {
        return ProfilerConfig.builder()
                ...
                .transformation(TransformationConfig.builder()
                        .alias("page_family")
                        .expression(ExpressionConfig.udf(" SOJ_PAGE_FAMILY(__RAW_EVENT)"))
                        .build()
                )
                .transformation(TransformationConfig.builder()
                ...
                .transformation(TransformationConfig.builder()
                        .alias("item")
                        .expression(ExpressionConfig.udf(" SOJ_NVL(__RAW_EVENT, 'itm|itmid|itm_id|itmlist|litm')"))
                        .build()
                )
                .transformation(TransformationConfig.builder()
    ...
    public static ProfilerConfig createProfilerExample3() {
        return ProfilerConfig.builder()
                ...
                .transformation(TransformationConfig.builder()
                        .alias("page_id")
                        .expression(ExpressionConfig.udf(" SOJ_NVL(__RAW_EVENT, 'p')"))
                        .build()
                )
                .transformation(TransformationConfig.builder()
                        .alias("t_duration")
                        .expression(ExpressionConfig.expr("CAST( SOJ_NVL(__RAW_EVENT, 'TDuration') AS DOUBLE)"))
                        .build()
                )
                .transformation(TransformationConfig.builder()
