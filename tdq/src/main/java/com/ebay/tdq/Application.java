...
import static com.ebay.tdq.utils.TdqConstant.*;
...
public class Application {
    public void start(String[] args) throws Exception {
        ...
        final StreamExecutionEnvironment env = FlinkEnvFactory.create(args);
...
//        DataStream<RawEvent> rawEventDataStream = BehaviorPathfinderSource.build(env);
    ...
    private void outputMetricByWindow(
    ...
    private SingleOutputStreamOperator<TdqMetric> reduceMetric(
    ...
    private SingleOutputStreamOperator<TdqMetric> normalizeEvent(
