...
public class RuleConstants {
    public static final String rule1Path = "ruletest/rule1.yaml";
    public static final String rule12Path = "ruletest/rule12.yaml";

    public static final String eventRuleType = "UbiEvent";
    public static final String sessionRuleType = "session";
    public static final String ipAttributeRuleType = "ipAttribute";
