...
@Slf4j
public class RawEventDeserializationSchemaForSLC implements DeserializationSchema<RawEvent> {
  ...
  private static final String DC_SLC = "SLC";
  ...
  public RawEvent deserialize(byte[] message) throws IOException {
    ...
    return new RawEvent(rheosHeader, sojAMap, sojKMap, sojCMap, clientData, DC_SLC, ingestTime);
  }
