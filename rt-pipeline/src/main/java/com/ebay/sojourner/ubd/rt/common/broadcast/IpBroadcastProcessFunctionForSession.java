...
public class IpBroadcastProcessFunctionForSession extends BroadcastProcessFunction<UbiSession, IpSignature,UbiSession> implements Serializable {
    private static volatile Logger logger = Logger.getLogger(IpBroadcastProcessFunctionForSession.class);
...
//
    ...
    @Override
    public void processBroadcastElement(IpSignature ipSignature, Context context, Collector<UbiSession> out) throws Exception {
