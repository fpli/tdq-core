...
public class RheosHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * Event creation time. This is the time the event is created.   * @param value the value to set.
   */
   ...
   * Event sent time. This is the time the event is sent out to Kafka. It is not necessary equal to eventCreateTimestamp.   * @param value the value to set.
   */
  ...
  public static io.ebay.rheos.schema.event.RheosHeader.Builder newBuilder() {
    return new io.ebay.rheos.schema.event.RheosHeader.Builder();
  }
  
  /** Creates a new RheosHeader RecordBuilder by copying an existing Builder */
  public static io.ebay.rheos.schema.event.RheosHeader.Builder newBuilder(io.ebay.rheos.schema.event.RheosHeader.Builder other) {
    return new io.ebay.rheos.schema.event.RheosHeader.Builder(other);
  }
  
  /** Creates a new RheosHeader RecordBuilder by copying an existing RheosHeader instance */
  public static io.ebay.rheos.schema.event.RheosHeader.Builder newBuilder(io.ebay.rheos.schema.event.RheosHeader other) {
    return new io.ebay.rheos.schema.event.RheosHeader.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RheosHeader>
    ...
    private Builder() {
      super(io.ebay.rheos.schema.event.RheosHeader.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(io.ebay.rheos.schema.event.RheosHeader.Builder other) {
      super(other);
    ...
    private Builder(io.ebay.rheos.schema.event.RheosHeader other) {
            super(io.ebay.rheos.schema.event.RheosHeader.SCHEMA$);
      if (isValidValue(fields()[0], other.eventCreateTimestamp)) {
        this.eventCreateTimestamp = data().deepCopy(fields()[0].schema(), other.eventCreateTimestamp);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'eventCreateTimestamp' field */
    public io.ebay.rheos.schema.event.RheosHeader.Builder setEventCreateTimestamp(long value) {
    ...
    public io.ebay.rheos.schema.event.RheosHeader.Builder clearEventCreateTimestamp() {
    ...
    /** Sets the value of the 'eventSentTimestamp' field */
    public io.ebay.rheos.schema.event.RheosHeader.Builder setEventSentTimestamp(long value) {
    ...
    public io.ebay.rheos.schema.event.RheosHeader.Builder clearEventSentTimestamp() {
    ...
    /** Sets the value of the 'schemaId' field */
    public io.ebay.rheos.schema.event.RheosHeader.Builder setSchemaId(int value) {
    ...
    public io.ebay.rheos.schema.event.RheosHeader.Builder clearSchemaId() {
    ...
    /** Sets the value of the 'eventId' field */
    public io.ebay.rheos.schema.event.RheosHeader.Builder setEventId(java.lang.String value) {
    ...
    public io.ebay.rheos.schema.event.RheosHeader.Builder clearEventId() {
      eventId = null;
    ...
    /** Sets the value of the 'producerId' field */
    public io.ebay.rheos.schema.event.RheosHeader.Builder setProducerId(java.lang.String value) {
    ...
    public io.ebay.rheos.schema.event.RheosHeader.Builder clearProducerId() {
      producerId = null;
