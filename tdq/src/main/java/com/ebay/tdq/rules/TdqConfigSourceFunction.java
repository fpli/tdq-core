...
public class TdqConfigSourceFunction extends RichSourceFunction<TdqConfig> {
    ...
    public void run(SourceContext<TdqConfig> ctx) throws Exception {
        ...
        TdqConfig config = objectMapper.reader().forType(TdqConfig.class)
                .readValue(new File("/Users/juntzhang/src/TDQ/sojourner-core/tdq/src/test/resources/q2/example3.json"));
        while (true) {
