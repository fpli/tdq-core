...
//            conf.setString(Property.IFRAME_PAGE_IDS4Bot12, getUBIProperty(Property.IFRAME_PAGE_IDS4Bot12));
    ...
    private static void setConfiguration() throws Exception {
        ...
        setLong(Property.EVENT_WAITING_PERIOD, Long.parseLong(getUBIProperty(Property.EVENT_WAITING_PERIOD)) * SOJTS2Date.MILLI2MICRO);
        setLong(Property.SESSION_IDLE_TIMEOUT, Long.parseLong(getUBIProperty(Property.SESSION_IDLE_TIMEOUT)) * SOJTS2Date.MILLI2MICRO);
        setLong(Property.SESSION_MAX_DURATION, Long.parseLong(getUBIProperty(Property.SESSION_MAX_DURATION)) * SOJTS2Date.MILLI2MICRO);
        setLong(Property.EVENT_DELAY_THRESHOLD, Long.parseLong(getUBIProperty(Property.EVENT_DELAY_THRESHOLD)) * SOJTS2Date.MILLI2MICRO);
        // Set event properties
        setLong(Property.EVENT_POOL_THRESHOLD, Long.valueOf(getUBIProperty(Property.EVENT_POOL_THRESHOLD)));
        ...
        setLong(Property.LARGE_SESSION_EVENT_NUMBER, Long.valueOf(getUBIProperty(Property.LARGE_SESSION_EVENT_NUMBER)));
        setLong(Property.LARGE_SESSION_TIMES_OF_BOT15, Long.valueOf(getUBIProperty(Property.LARGE_SESSION_TIMES_OF_BOT15)));
