...
public class SojEventTimeSessionWindows extends MergingWindowAssigner<Object, TimeWindow> {
  ...
  protected SojEventTimeSessionWindows(long sessionTimeout) {
    if (sessionTimeout <= 0) {
  ...
  protected SojEventTimeSessionWindows(long sessionTimeout, long sessionMaxDuration) {
    this(sessionTimeout);
   ...
   * @return The policy.
   */
  public static SojEventTimeSessionWindows withGap(
      Time size) {
    return new SojEventTimeSessionWindows(size.toMilliseconds());
  }

  public static SojEventTimeSessionWindows withGapAndMaxDuration(
      Time size, Time maxDuration) {
    return new SojEventTimeSessionWindows(size.toMilliseconds(), maxDuration.toMilliseconds());
  }
