...
public class KafkaConnectorFactoryForSOJQA {
    ...
    public static FlinkKafkaConsumer<byte[]> createKafkaConsumerWithBinary() {

        Properties props = new Properties();
        props.put("sasl.mechanism", "IAF");
        props.put("security.protocol", "SASL_PLAINTEXT");
        String config = "io.ebay.rheos.kafka.security.iaf.IAFLoginModule required iafConsumerId=\"urn:ebay-marketplace-consumerid:68a97ac2-013b-4915-9ed7-d6ae2ff01618\" iafSecret=\"6218c197-200e-49d7-b404-2a4dbf7595ef\" iafEnv=\"staging\";";
...
//        props.put(ConsumerConfig.CLIENT_ID_CONFIG, CLIENT_ID);
    ...
    public static FlinkKafkaConsumer<RawEvent> createKafkaConsumerWithRawEvent() {
