...
public class IntermediateSessionToSessionCoreMapFunction extends
    RichMapFunction<IntermediateSession,
        SessionCore> {
  ...
  private SessionCore transToSessionCore(IntermediateSession session) throws Exception {
  ...
  public int getFlags(IntermediateSession session) throws Exception {
