...
public class SojournerUBDRTJob {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //                .setParallelism(25);
    //
    //        agentAttributeDataStream.addSink(new
    // DiscardingSink<>()).setParallelism(25).name("Agent Signature");
    //
    ...
    //                .setParallelism(25);
    //
    //        ipAttributeDataStream.addSink(new DiscardingSink<>()).setParallelism(25).name("Ip
    // Signature");
    ...
    //        agentIpConnectDataStream.addSink(new DiscardingSink<>()).name("ubiEvent with SessionId
    // and bot");
