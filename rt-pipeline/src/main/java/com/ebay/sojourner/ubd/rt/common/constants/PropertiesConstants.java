...
public class PropertiesConstants {
    ...
    public static final String STREAM_RESTARTSTRATEGIES_ATTEMPTS = "stream.restart.strategies.attempts";
    public static final String STREAM_RESTARTSTRATEGIES_DELAYINTERVAL = "stream.restart.strategies.delay.interval";
