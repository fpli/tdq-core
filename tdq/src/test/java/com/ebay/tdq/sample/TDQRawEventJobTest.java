...
public class TDQRawEventJobTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<RawEvent> src1 = env.addSource(new MockTdqRawEventSourceFunction()).name("Raw " +
                "Event Src1").uid(
                "raw_event_src1");
        DataStream<RawEvent> src2 = env.addSource(new MockTdqRawEventSourceFunction()).name("Raw " +
                "Event Src2").uid(
                "raw_event_src2");
