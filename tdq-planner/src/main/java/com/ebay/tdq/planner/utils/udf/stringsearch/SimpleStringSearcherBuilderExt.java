...
public class SimpleStringSearcherBuilderExt {
  ...
  /**
   * Configure the Trie to ignore case when searching for keywords in the text. This must be called before calling
   * addSearchString because the algorithm converts keywords to lowercase as they are added, depending on this case
   * sensitivity setting.
   *
   * @return This builder.
   */
  ...
  /**
   * Adds a keyword to the Trie's list of text search keywords. No Payload is supplied.
   *
