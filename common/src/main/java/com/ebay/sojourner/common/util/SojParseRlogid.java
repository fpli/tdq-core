 ...
 * @author juntzhang
 */
public class SojParseRlogid {
  private static final int[] s_xors = {6, 7, 3, 5};
  private static final String DEFAULT_DATE_FORMAT = "yyyy-MM-dd HH:mm:ss";
  private final DateTimeFormatter formatter = DateTimeFormat.forPattern(DEFAULT_DATE_FORMAT)
