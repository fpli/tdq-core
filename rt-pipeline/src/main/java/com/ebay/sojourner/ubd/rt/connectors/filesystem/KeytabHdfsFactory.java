...
public class KeytabHdfsFactory {
  ...
  public static UserGroupInformation getUGI(ParameterTool parameterTool)
      throws IOException, InterruptedException, KrbException {
    ...
    //
    // System.setProperty("java.security.krb5.conf",KeytabHdfsFactory.class.getResource("/11/" +
    // krb5Filename).getPath() );
    //        System.setProperty("java.security.auth.login.config",
    // KeytabHdfsFactory.class.getResource("/" + jaasFilename).getPath());
    ...
    if (isProd) {
      ...
      ugi =
          UserGroupInformation.loginUserFromKeytabAndReturnUGI(principal, "/tmp/" + keyTabFilename);
  ...
  public static org.apache.hadoop.conf.Configuration getConf(boolean isProd)
    ...
    if (isProd) {
      ...
      // hadoopConfig.addResource(KeytabHdfsFactory.class.getResource(
      // String.format("%s/core-site.xml", cluster.getConfFolder())));
  ...
  public static UserGroupInformation getUGI() throws IOException, InterruptedException {
    ...
    // hadoopConfig.addResource(KeytabHdfsFactory.class.getResource(
    // String.format("%s/core-site.xml", cluster.getConfFolder())));
    hadoopConfig.addResource(
        Objects.requireNonNull(
            KeytabHdfsFactory.class.getClassLoader().getResource("core-site.xml")));
    hadoopConfig.addResource(
        Objects.requireNonNull(
            KeytabHdfsFactory.class.getClassLoader().getResource("hdfs-site.xml")));
    // hadoopConfig.addResource(Objects.requireNonNull(
    // KeytabHdfsFactory.class.getClassLoader().getResource("mapred-site.xml")));
    // hadoopConfig.addResource(Objects.requireNonNull(
    // KeytabHdfsFactory.class.getClassLoader().getResource("federation-mapping.xml")));
