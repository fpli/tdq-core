...
import com.ebay.sojourner.ubd.common.sharedlib.metrics.AttributeFlagMetrics;
...
public class AttributeFlagMetricsTest {
    ...
    public void test1() {
        ...
        ubiEvent.setApplicationPayload("ebay&rule=ebay&abvar=ebay&test=ebay&tui_abtest=ebay&epr=ebay&pgV=ebay&Motors20Group=ebay");
        ...
        Assertions.assertEquals(true, sessionAccumulator.getUbiSession().getUserIdSet().contains("haxi"));
    ...
    public void test4() {
        ubiEvent.setSojDataDt(20200120L);
        ubiEvent.setApplicationPayload("ebay&rule=ebay&test=ebay&tui_abtest=ebay&epr=ebay&pgV=ebay&Motors20Group=ebay");
        ubiEvent.setWebServer("ebay.half");
        ubiEvent.setReferrer("ebaypages.ebay.com/expresshttp://www.express.ebay");
        ubiEvent.setPageId(2588);
        ubiEvent.setUserId("haxi");
    ...
    public void test5() {
        ubiEvent.setSojDataDt(20200120L);
        ubiEvent.setApplicationPayload("ebay&rule=ebay&tui_abtest=ebay&epr=ebay&pgV=ebay&Motors20Group=ebay");
        ubiEvent.setWebServer("ebay.half");
        ubiEvent.setReferrer("ebaypages.ebay.com/expresshttp://www.express.ebay");
        ubiEvent.setPageId(2588);
        ubiEvent.setUserId("haxi");
