...
public class Guid extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4352833556245501469L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Guid\",\"namespace\":\"com.ebay.sojourner.common.model\",\"fields\":[{\"name\":\"guid1\",\"type\":\"long\"},{\"name\":\"guid2\",\"type\":\"long\"}]}");
   ...
   */
  public static com.ebay.sojourner.common.model.Guid.Builder newBuilder() {
    return new com.ebay.sojourner.common.model.Guid.Builder();
  }
   ...
   * @return A new Guid RecordBuilder
   */
  public static com.ebay.sojourner.common.model.Guid.Builder newBuilder(com.ebay.sojourner.common.model.Guid.Builder other) {
    return new com.ebay.sojourner.common.model.Guid.Builder(other);
  }
   ...
   * @return A new Guid RecordBuilder
   */
  public static com.ebay.sojourner.common.model.Guid.Builder newBuilder(com.ebay.sojourner.common.model.Guid other) {
    return new com.ebay.sojourner.common.model.Guid.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Guid>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ebay.sojourner.common.model.Guid.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ebay.sojourner.common.model.Guid other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.guid1)) {
        this.guid1 = data().deepCopy(fields()[0].schema(), other.guid1);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.sojourner.common.model.Guid.Builder setGuid1(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.sojourner.common.model.Guid.Builder clearGuid1() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.sojourner.common.model.Guid.Builder setGuid2(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.sojourner.common.model.Guid.Builder clearGuid2() {
