...
// */
//@Slf4j
//public class RheosEventProcessFunction extends ProcessFunction<RheosEvent, TdqMetric>
...
//
//  public RheosEventProcessFunction(TdqContext tdqCxt) {
//    this.tdqCxt = tdqCxt;
...
//
//  @Override
//  public void processElement(RheosEvent event, Context ctx, Collector<TdqMetric> collector) throws Exception {
...
//  }
//
//  private void processElement0(RheosEvent event,
...
//    }
//    if (tdqEnv.isNotProcessElement((long)event.get("viTimestamp"))) {
