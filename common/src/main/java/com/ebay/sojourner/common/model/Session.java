...
public class Session extends org.apache.avro.specific.SpecificRecordBase implements
   ...
   */
  @Deprecated
  public RheosHeader rheosHeader;
  /**
   * map from tag g
   */
  @Deprecated
   ...
   */
  public Session(RheosHeader rheosHeader,
   ...
   */
  public static Session.Builder newBuilder(
      Session.Builder other) {
    return new Session.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Session>
     ...
     */
    private Builder(Session.Builder other) {
      super(other);
     ...
     */
    public Session.Builder setRheosHeader(
        RheosHeader value) {
     ...
     */
    public Session.Builder clearRheosHeader() {
      rheosHeader = null;
     ...
     */
    public Session.Builder setGuid(java.lang.String value) {
     ...
     */
    public Session.Builder clearGuid() {
      guid = null;
    ...
    public Session build() {
      try {
        ...
        record.rheosHeader = fieldSetFlags()[0] ? this.rheosHeader
            : (RheosHeader) defaultValue(fields()[0]);
