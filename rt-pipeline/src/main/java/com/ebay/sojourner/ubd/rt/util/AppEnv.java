...
public class AppEnv {
        ...
        if (appEnv == null) {
            synchronized (AppEnv.class) {
                if (appEnv == null) {
                    ...
                    try {
                        InputStream inputStream = AppEnv.class.getClassLoader().getResourceAsStream(CONFIG_FILE_NAME);
                        Map<String, Object> config = objectMapper.readValue(inputStream,
    ...
    private static void replaceWithParamTool(Map<String, Object> config, ParameterTool parameterTool) {
    ...
    private static Map<String, Object> nestReplace(String key, Map<String, Object> map, ParameterTool parameterTool) {
